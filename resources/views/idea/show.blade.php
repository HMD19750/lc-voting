            ...
            <div class="w-full mx-2 md:mx-4">
                ...
                <div class="flex flex-col justify-between mt-6 md:flex-row md:items-center">
                    <div class="flex items-center space-x-2 text-xs font-semibold text-gray-400">
                        <div class="hidden font-bold text-gray-900 md:block">{{ $idea->user->username }}</div>
                    ...
                    <div
                        ...
                        x-data="{ isOpen: false }"
                    >
                        <div class="{{ $idea->getStatusClasses() }} px-4 py-2 font-bold leading-none text-center uppercase rounded-full text-xxs w-28 h-7">
                            {{ $idea->status->name }}
                        </div>
                        <button
