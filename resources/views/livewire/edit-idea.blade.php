<div x-cloak x-data="{isOpen:false,markDown:true }" x-show="isOpen" @keydown.escape.window="isOpen=false"
    ...
    <div class="flex items-end justify-center min-h-screen ">
        ...
        <div x-show="isOpen" x-transition.origin.bottom.duration.500ms
            ...
            <div class="px-4 pt-5 pb-4 bg-white sm:p-6 sm:pb-4">
                ...
                <h3 class="text-lg font-bold text-center text-gray-900">Edit idea</h3>
